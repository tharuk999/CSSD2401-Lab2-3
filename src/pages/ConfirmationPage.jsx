  ...
  return (
    <main id="main-content" className="relative max-w-2xl mx-auto px-5 py-14" tabIndex={-1}>
      ...
      <div aria-hidden="true" className="pointer-events-none fixed inset-0">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full opacity-12"
      ...
      <div className="relative z-10 space-y-6">
        ...
        <section className="card space-y-4 page-enter stagger-1" aria-label="Order details">
            ...
            <div key={item.id} className="flex gap-4 items-center">
              <div className="w-12 h-16 flex-shrink-0 rounded-lg overflow-hidden shadow-md"
                ...
                <div className="h-full flex items-center justify-center p-1">
                  <p className="font-display text-amber-400 text-xs italic text-center leading-tight">DoET</p>
                </div>
              </div>
          ...
          <div className="border-t border-night-600 pt-4 space-y-2 text-sm">
            <div className="flex justify-between text-night-200"><span>Subtotal</span><span className="text-white">${order.subtotal.toFixed(2)}</span></div>
            <div className="flex justify-between text-night-200"><span>Shipping</span>
              {order.shipping === 0
        ...
        <section className="card page-enter stagger-2" aria-label="Shipping information">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-night-200">{order.shipping_address.city}, {order.shipping_address.province} {order.shipping_address.postal}</p>
            </div>
          </div>
          <div className="mt-4 flex items-center gap-3 text-sm bg-night-700/50 rounded-xl px-4 py-3 border border-night-600/40">
            ...
            <span className="text-night-200">Estimated delivery: <strong className="text-white">2-4 business days</strong></span>
          </div>
        </section>
